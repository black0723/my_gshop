    ...
    <div class="info-content">
      ...
      <section class="section">
        ...
        <div class="activity">
          ...
          <div class="activity-item" :class="supportClass[s.type]" v-for="(s,index) in info.supports" :key="index">
      ...
      <section class="section">
        ...
        <div class="pic-wrapper">
          <ul class="pic-list" ref="picsUl">
            <li class="pic-item" v-for="(o,i) in info.pics" :key="i">
              <img width="120" height="90" :src="o"/>
            </li>
